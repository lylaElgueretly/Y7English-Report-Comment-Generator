...
# Multiple variations per band included for random selection
# =========================================
...
attitude_bank = {
    ...
    85: [
        ...
        "showed strong commitment and enthusiasm in lessons",
    ],
    80: [
        "showed a positive and motivated attitude towards learning and participated confidently",
        "participated actively and maintained a good attitude towards learning",
    ],
...
# ---------- READING BANK ----------
reading_bank = {
    90: ["understood texts and made insightful interpretations", "demonstrated deep comprehension and interpretation skills"],
    85: ["understood texts confidently and made strong interpretations", "read and interpreted texts with confidence"],
...
# ---------- WRITING BANK ----------
writing_bank = {
    90: ["expressed ideas clearly using varied vocabulary and sentence structures", "wrote with excellent clarity and creativity"],
